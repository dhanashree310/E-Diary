...
echo "<script type='text/javascript'> document.location ='welcome2.html'; </script>";
}else{
...
return true;
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">E-Diary | Password Recovery</h3></div>
                                    <div class="card-body">
 ...
 <div class="form-floating mb-3">
                              ...
                              <div class="card-footer text-center py-3">
                                        <div class="small"><a href="welcome2.html">Back to Home Page</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
